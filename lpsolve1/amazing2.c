...
#define nspot 50   //number of spot prices
#define tc 0.0833333     //time for checkpointing
#define tr 0.0833333     //time for restart
#define W 100       //work required
#define td 300      //deadline
#define num 2000   //number of iterations to run on, to check our program
